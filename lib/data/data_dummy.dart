...
List<ListItem> listTiles = [
    ...
    ListItem(
      "https://media.istockphoto.com/photos/frog-in-rocky-pond-picture-id91516350?k=20&m=91516350&s=612x612&w=0&h=h4zFCj-3TMQrVK0mFKkKyyKL5Md0W7wb79q9iZ0E8Uk=",
      "Horned Frog",
      "Argentina",
      "Amfibi",
      "Katak bertanduk Argentina ( Ceratophrys ornata ), juga dikenal sebagai katak bermulut lebar Argentina , katak bertanduk hiasan , katak bertanduk hiasan , atau katak pacman hiasan , adalah spesies katak dalam famili Ceratophryidae . Spesies ini endemik di Amerika Selatan . Ini adalah spesies katak bertanduk yang paling umum , di padang rumput Argentina , Uruguay dan Brasil . Pemakan rakus, ia akan mencoba menelan apa pun yang bergerak di dekat mulutnya yang lebar, seperti serangga, tikus, kadal , dan katak lainnya , bahkan jika predator ini akan mati lemas dalam prosesnya. Hal ini juga disimpan sebagai hewan peliharaan yang eksotis . Julukan 'pacman frog' mengacu pada permainan arcade populer tahun 1980-an Pac-Man , di mana Pac-Man sendiri makan cukup banyak, dan memiliki mulut yang menempati sebagian besar tubuhnya, mirip dengan katak bertanduk Argentina."
    ),
  ];
...
List<ListItem> listPop = [
    ...
    ListItem(
      "https://media.istockphoto.com/photos/green-sea-turtle-swimming-underwater-picture-id178840843?k=20&m=178840843&s=612x612&w=0&h=oTkq28NW4EXsBATub8Tgh7x308oLt1fCNtJly2O6uyc=",
      "Penyu",
      "Lombok",
      "Amfibi",
      "Dari 7 spesies, 6 spesies penyu hidup di Indonesia. Karena banyaknya spesies penyu yang berhasil hidup di Indonesia, pemerintah juga melindungi hewan ini dengan membuatkan penangkaran di berbagai daerah. Di antaranya adalah di pulau Tanjung Benoa-Bali, Kepulauan Seribu, dan Lombok.\n\nUntungnya, masyarakat di Indonesia percaya bahwa penyu merupakan hewan pembawa keberuntungan. Sehingga, mereka juga banyak membantu dalam pemeliharaan penyu."
    ),
    ListItem(
      "https://media.istockphoto.com/photos/tarsius-sits-on-a-tree-in-the-jungle-picture-id677452040?k=20&m=677452040&s=612x612&w=0&h=0vLDufa0PYfbTl6-z06EFt3gJ9qyCBpcmxr2dbwcEiE=",
      "Tarsius tarsier",
      "Sulawesi",
      "Mamalia",
    ...
    ListItem(
      "https://media.istockphoto.com/photos/sumatran-tiger-in-jakarta-zoo-picture-id1330054889?k=20&m=1330054889&s=612x612&w=0&h=awFv3Ja7_VhzJoaDSOuC_3CFW1PGg9HHZlBlfYJRDpg=",
      "Harimau Sumatera",
      "Sumatera",
      "Mamalia",
    ...
    ListItem(
      "https://media.istockphoto.com/photos/javan-rhino-in-forest-clearing-picture-id1295039680?k=20&m=1295039680&s=612x612&w=0&h=0KD6tx_fQHg9IsL1bKC-De2JDpnGltDPfxjfTPWDwhA=",
      "Badak Bercula Satu",
      "Jawa",
      "Mamaila",
  ...
  List<ListItem> listBonus = [
    ListItem(
      "",
      "Dapa",
      "rumah",
      "orang",
      "saya adalah Lord tujui saya ganteng sekali tapi sekalinya saya Lord tujui saya ganteng sekali tapi sekalinya saya beli Bktbeli Bkt"
    ),
  ];
